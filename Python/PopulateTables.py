...
AttrMap = {'[USER]': 7, 'TOURNAMENT': 10, 'TEAM_STAFF_ROLE': 2, 'TEAM_STAFF': 6, 'TEAM_PLAYS': 2, 'TEAM': 8, 'STAT': 5,
...
""" INSERT TEAMS """
# records = generateRandomTeams(500)
# insert('TEAM', records)

""" INSERT PLAYERS """
# records = generateRandomPlayers(420)
